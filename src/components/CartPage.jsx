    ...
    <div className="w-full max-w-6xl mx-auto py-10 sm:py-16 px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
        ...
        <div className="lg:col-span-7 space-y-4 sm:space-y-6 md:space-y-8">
          {cart.map((item) => (
            <div key={item.id} className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-5 sm:p-6 md:p-8 bg-[#2D3025]/40 rounded-2xl sm:rounded-3xl border border-[#E6DCC8]/10">
              <div className="flex items-center gap-4 sm:gap-6 min-w-0 flex-1">
                ...
                <h3 className="font-bold text-base sm:text-lg md:text-xl text-[#E6DCC8] min-w-0 truncate">{item.name}</h3>
              </div>
